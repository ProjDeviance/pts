<?php $wfName = Workflow::find('5'); ?>
<br/>

<!-- PURCHASE REQUEST SECTION -->
<div class="panel panel-success">
	<div class="panel-heading">
		<?php $sectionName = Section::find('16'); ?>
	...
	<div class="panel-body">
		...
		<table border="1" class="workflow-table">
			...
			<?php 
				$sections = DB::table('tasks')->where('wf_id','5')->get(); 
			?>
...
<div class="panel panel-success">
	<div class="panel-heading">
		<?php $sectionName = Section::find('17'); ?>
...
<div class="panel panel-success">
	<div class="panel-heading">
		<?php $sectionName = Section::find('18'); ?>
		<h3 class="panel-title">{{{ strtoupper($sectionName->sectionName) }}}</h3>
	</div>
...
<div class="panel panel-success">
	<div class="panel-heading">
		<?php $sectionName = Section::find('19'); ?>
		<h3 class="panel-title">{{{ strtoupper($sectionName->sectionName) }}}</h3>
	</div>
